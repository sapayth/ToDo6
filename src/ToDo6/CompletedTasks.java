...
public class CompletedTasks extends JFrame {
    ...
    public CompletedTasks() {
        ...
        // heading
        headerLabel = new JLabel("Completed Tasks");
...
//        add(btnClear);
    ...
    public void showCompletedTasks() {
        completedTasksAL.clear();
        File fileCompletedTasks = new File("CompletedTasks.txt");
        try {
            BufferedReader br = new BufferedReader(new FileReader(fileCompletedTasks));
            String t = "";
            while ((t = br.readLine()) != null) {
                completedTasksAL.add(t);
            }
            for ( String s : completedTasksAL ) {
                // build single tasks
...
//        completed.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//        completed.setSize(400, 600);
//        completed.setLocationRelativeTo(null);
